    ...
    <div class="collapse position-fixed end-0 me-3 mb-3" id="collapseExample" style="z-index: 1000;bottom: 5rem;">
        <div class="card shadow-lg border-0" style="width: 400px; height: 515px; border-radius: 1rem;">
            ...
            <div id="btn-form-name" class="footer px-3 py-3" style="background-color: #F5F4F7; border-bottom-left-radius: 1rem;border-bottom-right-radius: 1rem;">
                <div class="row g-0 ">
                    <button id="btn-form-name" class="btn-green position-absolute bottom-0 start-50 translate-middle-x btn btn-send border-0 text-white fw-bold py-3" id="btn-send" style="background-color: #00A389; border-radius: 0rem 0rem 1rem 1rem">
                        Kirim
                    </button>
                </div>
            </div>
    ...
    <script > 
        $(document).ready(function(){
            ...
            conn.onmessage = function(e) {
                ...
                // var html_data = "<div class='col-12 mb-3'><span class='px-3 pt-2 pb-4 chat-bubble float-end text-white position-relative' style='background-color: #00A389; min-width: 20%; max-width: 80%; border-radius: 1rem!important;'>"+data.msg+"<span class='text-white-50 position-absolute bottom-0 end-0 me-2 mb-1' style='font-size: .8rem;'>"+moment().format('LT')+"</span></span></div>";
