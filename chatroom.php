...
<html>
<head>
	<title>ChatRoom Multi User</title>
	<!-- Bootstrap core CSS -->
...
<!--				</form>-->
			...
			<div class="col-lg-4">
				...
				<div class="mt-3 mb-3 text-center">
                    ...
                    <a href="logout.php" class="btn btn-primary mt-2 mb-2" name="logout" id="logout" value="Logout" >Logout</a>
				</div>
				<?php
				}
				?>
            ...
            if(count($user_data) > 0) {
                foreach ($user_data as $key => $user) {
                    if ($user['user_id'] != $login_user_id) {
                        echo '
                            <img src="'.$user["user_profile"].'" class="img-fluid rounded-circle img-thumbnail" width="30" />
                        ';
                    }
                }
            }
